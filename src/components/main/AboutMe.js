      ...
      <section className="about-me">
        ...
        <div class="about-me__wrapper">
            <div class="about-me__description">
                ...
                <p class="about-me__text">Я родился и живу в Рыбинске. Жены и детей нет. Я люблю слушать музыку, И заниматя разными видами спорта. Люблю природу и животных. Недавно начал кодить. В данный момент работаю в строительстве. Так же увлекаюсь 3д моделированиием - 3д.печатью - Видео, фото - монтажом. Всегда интересовался програмированием, как прошёл курс по веб-разработке, начал понимать что материал неплохо так усваивается и дальнеюшую деятельность планирую связать с кодингом!</p>
